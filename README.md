...
You have a "workload SA" (workload@hack-team-the-brainwaves.iam.gserviceaccount.com) that you can use to attach to your workloads (e.g. Cloud Run revisions).
...
https://europe-west4-aiplatform.googleapis.com/v1/projects/hack-team-the-brainwaves/locations/europe-west4/pipelineJobs?pipelineJobId=tune-large-model-$(date +"%Y%m%d%H%M%S") -d \
$'{
    "displayName": "tune-large-model",    
    "serviceAccount": "workload@hack-team-move.iam.gserviceaccount.com", 
    "runtimeConfig": {
        "gcsOutputDirectory": "gs://artifacts.hack-team-the-brainwaves.appspot.com/Foo/",
        "parameterValues": {
            "location": "us-central1",
            "project": "hack-team-the-brainwaves",
            "large_model_reference": "text-bison@001",
            "model_display_name": "mytunedmodel_1",
            "train_steps": 100,
            "encryption_spec_key_name": "",
            "dataset_uri": "gs://artifacts.hack-team-the-brainwaves.appspot.com/Bar.jsonl",
            "evaluation_data_uri": "",
...
* vars.PROJECT_NUMBER - Your teams' GCP Project Number.: 317075551903
...
* project_number - Your teams' GCP Project Number.: 317075551903
...
* workload_sa_email - The email address representation of the SA you can attach to your workloads (e.g. to a Cloud Run service). : workload@hack-team-the-brainwaves.iam.gserviceaccount.com
